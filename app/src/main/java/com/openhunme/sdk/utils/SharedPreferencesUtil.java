...
public class SharedPreferencesUtil {
	...
	public static String TF_PREFERENCE_NAME = "hmsharedpreference";
	...
	public static SharedPreferencesUtil getInstance() {
		...
		if (mSharedPreferences == null) {
			HunmeApplication app = HunmeApplication.getInstance();
			mSharedPreferences = app.getSharedPreferences(TF_PREFERENCE_NAME, Context.MODE_PRIVATE);
		}
		if (editor == null) {
